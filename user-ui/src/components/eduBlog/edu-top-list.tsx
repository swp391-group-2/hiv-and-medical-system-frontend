...
function EduTopList() {
  ...
  if (isError) {
    return (
      <ErrorQuery
        error={error}
        message="Không thể tải tài liệu giáo dục"
        onRetry={refetch}
      />
    );
  }
          ...
          <div className="text-center space-y-6 max-w-lg">
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-500 leading-relaxed">
                Hiện tại chưa có tài liệu giáo dục nào. Chúng tôi đang cập nhật
                những nội dung hữu ích về HIV/AIDS.
              </p>
            </div>
          </div>
        </div>
