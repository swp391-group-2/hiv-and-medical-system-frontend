...
import { AlarmClockCheck, CircleDollarSign, Clock3, ShieldUser } from "lucide-react";
      ...
      <div className="flex-1 flex flex-col justify-start items-start space-y-4">
        ...
        <ul className="space-y-3 text-base">
          <li className="flex items-center gap-2">
            <span className="text-lg"><ShieldUser /></span>
            {notes[0]}
          </li>
          <li className="flex items-center gap-2">
            <span className="text-lg"><Clock3 /></span>
            {resultTime}
          </li>
          <li className="flex items-center gap-2">
            <span className="text-lg"><AlarmClockCheck /></span>
            {notes[1]}
          </li>
          <li className="flex items-center gap-2">
