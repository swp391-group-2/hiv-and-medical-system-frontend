...
const DoctorHero = () => {
  return (
    <section className="bg-gradient-to-br from-primary to-sky-200 py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-white flex-shrink-0 mt-1" />
                  <p className="text-gray-700 text-lg font-bold">
                    Được hướng chỉnh sách hoàn tiền khi đặt lịch trên medcare
          ...
          <div className="flex justify-center">
            <Card className="w-full max-w-md bg-transparent outline-0 border-0 shadow-none backdrop-blur-sm">
