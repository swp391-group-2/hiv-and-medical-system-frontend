      ...
      {doctors.map((doctor, index) => (
        ...
        >
          <CardContent className="p-4">
            ...
            {/* Booking Button */}
            <Link to={`/services/booking/doctors/${doctor.id}`}>
              <Button className="w-full   text-white font-medium py-3 rounded-lg shadow-md hover:shadow-lg transition-all duration-200">
