  ...
  useEffect(() => {
    ...
    const allDoctorsData: Doctor[] = [
      ...
      },
      {
        ...
        rating: 4.7,
        image: "https://www.fvhospital.com/wp-content/uploads/2018/09/drminhhien.jpg",
      },
      {
        name: "BS. CKI. Trần Văn Dũng",
        rating: 4.8,
        image: "https://rafflesmedical.vn/wp-content/uploads/2019/12/bs-phan-chu-trinh-e1575541397608-1603x2000.jpg",
      },
      {
        name: "TS. BS. Phạm Thị Thu Hà",
        rating: 4.5,
        image: "https://chaohanoi.com/wp-content/uploads/2020/02/Vietnam-doctor.jpg",
      },
      {
        name: "BS. Đoàn Quốc Bảo",
        rating: 4.6,
        image: "https://vnn-imgs-f.vgcloud.vn/2020/07/19/14/5-1.jpg?width=0&s=U4fe3mbjHzMw13D2sxdTVA",
      },
      {
        name: "BS. Nguyễn Hữu Nghĩa",
        rating: 4.4,
        image: "https://docosan.s3.ap-southeast-1.amazonaws.com/publics/images/doctor/1394/thumb/img2021102712072755829100.png",
      },
      {
        name: "BS. Nguyễn Tuấn Đình",
        rating: 4.7,
        image: "https://www.fvhospital.com/wp-content/uploads/2019/04/dr-nguyen-tuan-dinh-600x315.jpg",
      },
      {
        name: "BS. Trịnh Văn Hùng",
        rating: 4.9,
        image: "https://cdn2.tuoitre.vn/thumb_w/480/2018/2/10/bac-si-tran-huynh-151824259749249048360.jpg",
      },
      {
      ...
      },
      {
        name: "BS. Nam Trần",
        rating: 4.6,
        image: "https://bacsinam.vn/wp-content/uploads/2023/06/Bac-si-Nam-Tran-1024x1024.png",
      },
      {
      ...
      },
      {
        ...
        rating: 4.8,
        image: "https://phamnguyenvinh.org/wp-content/uploads/2019/06/dr-pham-nguyen-vinh-250x375.jpg",
      },
    ];
