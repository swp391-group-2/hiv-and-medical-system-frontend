        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-xl font-semibold">
              Hướng dẫn viết bài với Markdown
            </h2>
          </div>
          <p className="text-gray-600 mb-6">
            Học cách sử dụng Markdown để tạo ra những bài viết y khoa đẹp và
            chuyên nghiệp
          </p>
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              copyToClipboard(example.markdown, index)
                            }
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              copyToClipboard(example.markdown, index + 100)
                            }
                            className="flex items-center gap-1"
                          >
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              copyToClipboard(example.markdown, index + 200)
                            }
                            className="flex items-center gap-1"
                          >
            ...
            <TabsContent value="tips" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Những lời khuyên giúp bạn tạo ra những bài viết y khoa chất
                    lượng
                  </CardDescription>
                </CardHeader>
                <CardContent>
