import type { TreatmentHistory } from "@/pages/ARVSeclect/type";
...
const TreatmentHistoryCard = ({ history }: { history: TreatmentHistory }) => {
  return (
    <div className="bg-purple-50 p-4 rounded shadow text-purple-900">
      ...
      <p>Trạng thái: <span className={history.status.includes('Ngừng') ? 'text-red-600' : 'text-green-600'}>{history.status}</span></p>
